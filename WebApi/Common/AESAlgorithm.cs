...
namespace m2ostnextservice.Models
{
    internal class AESAlgorithm
    {
        ...
        public string getDecryptedString(string str)
        {
            ...
            // Create secret IV
            byte[] iv = new byte[16] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };
            string encrypted = new AESAlgorithm().DecryptString(str, key, iv);
            return encrypted;
        }
    }
}

//string key = "Y$driIufetUIF53f348127o0Ur3";//use same key
//string notEncryptedText = "203";//uid here
//string encryptedText = new AESAlgorithm().Encrypt(key, notEncryptedText);